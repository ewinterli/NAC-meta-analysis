...
Step 3:
- RRs are calculated here and then converted to logRRs in the "forest plots" code; note that these are calculated so that values below 0 indicate lower risk of AEs for NAC group
